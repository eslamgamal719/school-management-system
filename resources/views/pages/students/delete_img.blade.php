        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('delete_attachment') }}" method="post">
                    ...
                    <input type="hidden" name="student_name" value="{{$attachment->imageable->getTranslation('name', 'en')}}">
                    <input type="hidden" name="student_id" value="{{$attachment->imageable->id}}">

                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('site.delete_attachment_title')}}</h5>
