                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="home-02" role="tabpanel"
                                    ...
                                    <table class="table table-striped table-hover" style="text-align:center">
                                        <tbody>
                                        <tr>
                                            <th scope="row">{{trans('site.student_name')}}</th>
                                            <td>{{ $student->name }}</td>
                                                ...
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td colspan="2">
                                                        <a class="btn btn-outline-info btn-sm"
                                                           href="{{url('download_attachment')}}/{{ $attachment->imageable->getTranslation('name', 'en') }}/{{$attachment->filename}}"
                                                           role="button"><i class="fa fa-download"></i></a>

                                                        <a class="btn btn-outline-warning btn-sm"
                                                        href="{{url('show_attachment')}}/{{ $attachment->imageable->getTranslation('name', 'en') }}/{{$attachment->filename}}"
                                                        role="button"><i class="fa fa-eye"></i></a>

                                                        <button type="button" class="btn btn-outline-danger btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#delete_img{{ $attachment->id }}"
                                                                title="{{ trans('site.delete') }}"><i class="fa fa-trash"></i>
                                                        </button>
