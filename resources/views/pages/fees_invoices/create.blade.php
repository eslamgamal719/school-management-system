                                        ...
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="box">
                                                        <select class="custom-select mr-sm-2" id="fee_id" name="fee_id" required>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="box">
                                                        <select class="custom-select mr-sm-2" id="amount" name="amount" required>
                                                            <option value="">-- اختار من القائمة --</option>
                                                            @foreach($fees as $fee)
...
<script>
  /*  $(document).ready(function () {
        $(document).on('change', '#fee_id', function() {
            ...
            if (fee_id) {
            $.ajax({
                url: "{{ URL::to('fees_amount') }}/" + fee_id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                  console.log(data)
                    $('#amount').empty();
                    $('#amount').append('<option value="' + data + '">' + data + '</option>');
                }
            });
            } else {
                console.log('wrong');
